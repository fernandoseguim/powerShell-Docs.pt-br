...
Este exemplo mostra como criar um aplicativo host baseado em console interativo que lê os comandos da linha de comando, executa os comandos e, em seguida, exibe os resultados no console. Além disso, este exemplo usa as APIs do Criador de Token para especificar a cor do texto inserido pelo usuário.

## <a name="requirements"></a>Requisitos

- Este exemplo requer o Windows PowerShell 2.0.

- Este aplicativo deve ser executado no modo elevado (Executar como administrador).
...
- Criando um `$profile` variável e carregar os perfis a seguir.

  - usuário atual, o host atual

  - usuário atual, todos os hosts

  - todos os usuários, o host atual

  - todos os usuários, todos os hosts

- Implemente a [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.
...
- Use a API de criar tokens para colorir a linha de comando, como foi digitado.

## <a name="example"></a>Exemplo

 Este exemplo permite que o usuário insira os comandos em uma linha de comando, processa esses comandos e, em seguida, imprime os resultados.
...
## <a name="example"></a>Exemplo
 ...
 O código a seguir é a implementação do [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) classe que é usado por este aplicativo host. Os elementos que não são implementados lançam uma exceção ou retornará nada.
...
## <a name="example"></a>Exemplo
 ...
 O código a seguir é a implementação do [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe que é usado por este aplicativo host.
...
## <a name="example"></a>Exemplo
 ...
 O código a seguir é a implementação do [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe que é usado por este aplicativo host. Os elementos que não são implementados lançam uma exceção ou retornará nada.
...
## <a name="example"></a>Exemplo
 ...
 O código a seguir lê a linha de comando e cores o texto inserido. Tokens são determinados usando o [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) método.
