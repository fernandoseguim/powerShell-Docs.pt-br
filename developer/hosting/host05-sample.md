...
ms.locfileid: "57794409"
---
# <a name="host05-sample"></a><span data-ttu-id="eec60-102">Amostra Host05</span><span class="sxs-lookup"><span data-stu-id="eec60-102">Host05 Sample</span></span>

<span data-ttu-id="eec60-103">Este exemplo mostra como criar um aplicativo host baseado em console interativo que lê os comandos da linha de comando, executa os comandos e, em seguida, exibe os resultados no console.</span><span class="sxs-lookup"><span data-stu-id="eec60-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="eec60-104">Este aplicativo host também dá suporte a chamadas para computadores remotos com os cmdlets [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) e [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession).</span><span class="sxs-lookup"><span data-stu-id="eec60-104">This host application also supports calls to remote computers by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>

## <a name="requirements"></a><span data-ttu-id="eec60-105">Requisitos</span><span class="sxs-lookup"><span data-stu-id="eec60-105">Requirements</span></span>

- <span data-ttu-id="eec60-106">Este exemplo requer o Windows PowerShell 2.0.</span><span class="sxs-lookup"><span data-stu-id="eec60-106">This sample requires Windows PowerShell 2.0.</span></span>

- <span data-ttu-id="eec60-107">Este aplicativo deve ser executado no modo elevado (Executar como administrador).</span><span class="sxs-lookup"><span data-stu-id="eec60-107">This application must be run in elevated mode (Run as administrator).</span></span>

## <a name="demonstrates"></a><span data-ttu-id="eec60-108">Demonstra</span><span class="sxs-lookup"><span data-stu-id="eec60-108">Demonstrates</span></span>

- <span data-ttu-id="eec60-109">Criando um host personalizado cujas classes derivam a [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) classe, o [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe e o [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe.</span><span class="sxs-lookup"><span data-stu-id="eec60-109">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="eec60-110">Criar um aplicativo de console que usa essas classes de host para criar um shell interativo do Windows PowerShell.</span><span class="sxs-lookup"><span data-stu-id="eec60-110">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="eec60-111">Criando um `$profile` variável e carregar os perfis a seguir.</span><span class="sxs-lookup"><span data-stu-id="eec60-111">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="eec60-112">usuário atual, o host atual</span><span class="sxs-lookup"><span data-stu-id="eec60-112">current user, current host</span></span>

  - <span data-ttu-id="eec60-113">usuário atual, todos os hosts</span><span class="sxs-lookup"><span data-stu-id="eec60-113">current user, all hosts</span></span>

  - <span data-ttu-id="eec60-114">todos os usuários, o host atual</span><span class="sxs-lookup"><span data-stu-id="eec60-114">all users, current host</span></span>

  - <span data-ttu-id="eec60-115">todos os usuários, todos os hosts</span><span class="sxs-lookup"><span data-stu-id="eec60-115">all users, all hosts</span></span>

- <span data-ttu-id="eec60-116">Implemente a [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span><span class="sxs-lookup"><span data-stu-id="eec60-116">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

- <span data-ttu-id="eec60-117">Implemente a [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface para dar suporte a comunicação remota interativa usando o [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) e [ Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span><span class="sxs-lookup"><span data-stu-id="eec60-117">Implement the [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface to support interactive remoting by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>

## <a name="example"></a><span data-ttu-id="eec60-118">Exemplo</span><span class="sxs-lookup"><span data-stu-id="eec60-118">Example</span></span>

 <span data-ttu-id="eec60-119">Este exemplo permite que o usuário insira os comandos em uma linha de comando, processa esses comandos e, em seguida, imprime os resultados.</span><span class="sxs-lookup"><span data-stu-id="eec60-119">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="eec60-120">Exemplo</span><span class="sxs-lookup"><span data-stu-id="eec60-120">Example</span></span>

 <span data-ttu-id="eec60-121">O código a seguir é a implementação do [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) classe que é usado por este aplicativo host.</span><span class="sxs-lookup"><span data-stu-id="eec60-121">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="eec60-122">Os elementos que não são implementados lançam uma exceção ou retornará nada.</span><span class="sxs-lookup"><span data-stu-id="eec60-122">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="eec60-123">Exemplo</span><span class="sxs-lookup"><span data-stu-id="eec60-123">Example</span></span>

 <span data-ttu-id="eec60-124">O código a seguir é a implementação do [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe que é usado por este aplicativo host.</span><span class="sxs-lookup"><span data-stu-id="eec60-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="eec60-125">Exemplo</span><span class="sxs-lookup"><span data-stu-id="eec60-125">Example</span></span>

 <span data-ttu-id="eec60-126">O código a seguir é a implementação do [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe que é usado por este aplicativo host.</span><span class="sxs-lookup"><span data-stu-id="eec60-126">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="eec60-127">Os elementos que não são implementados lançam uma exceção ou retornará nada.</span><span class="sxs-lookup"><span data-stu-id="eec60-127">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="eec60-128">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="eec60-128">See Also</span></span>

 [<span data-ttu-id="eec60-129">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="eec60-129">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="eec60-130">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="eec60-130">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="eec60-131">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="eec60-131">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
