...
---
# <a name="remoterunspacepool01-sample"></a>Amostra RemoteRunspacePool01

Este exemplo mostra como construir um pool de Runspaces remotos e como executar vários comandos simultaneamente usando esse pool.
...
- Executando o [Get-Process](/powershell/module/Microsoft.PowerShell.Management/Get-Process) e [Get-Service](/powershell/module/microsoft.powershell.management/get-service) cmdlets simultaneamente usando o pool de Runspaces remotos.
- Executando o [Get-Process](/powershell/module/Microsoft.PowerShell.Management/Get-Process) e [Get-Service](/powershell/module/microsoft.powershell.management/get-service) cmdlets simultaneamente usando o pool de Runspaces remotos.

- Fechando o pool de Runspaces remotos para liberar a conexão remota.
