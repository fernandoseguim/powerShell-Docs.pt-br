---
title: Implementar a autorização de personalizado para um serviço da web OData de gerenciamento | Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56862582"
---
# <a name="implementing-custom-authorization-for-a-management-odata-web-service"></a><span data-ttu-id="1e223-102">Implementar autorização personalizada para um serviço Web OData de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="1e223-102">Implementing Custom Authorization for a Management OData web service</span></span>

<span data-ttu-id="1e223-103">Usando o serviço do Windows PowerShell Web requer um terceiro implementar o [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface para expor os cmdlets do Windows PowerShell.</span><span class="sxs-lookup"><span data-stu-id="1e223-103">Using the Windows PowerShell Web Service requires a third party to implement the [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface to expose Windows PowerShell cmdlets.</span></span> <span data-ttu-id="1e223-104">Essa interface executa a autorização de usuário para o serviço web.</span><span class="sxs-lookup"><span data-stu-id="1e223-104">This interface performs user authorization to the web service.</span></span> <span data-ttu-id="1e223-105">Depois de escrever o código para implementar a interface, você deve compilá-lo em uma DLL a ser usado no aplicativo web.</span><span class="sxs-lookup"><span data-stu-id="1e223-105">After writing the code to implement the interface, you must compile it into a DLL to be used in the web application.</span></span>

## <a name="pass-through-authorization"></a><span data-ttu-id="1e223-106">Autorização de passagem</span><span class="sxs-lookup"><span data-stu-id="1e223-106">Pass-through authorization</span></span>

<span data-ttu-id="1e223-107">A maneira mais simples de implementar o [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface é uma implementação de passagem que autoriza a todos os usuários.</span><span class="sxs-lookup"><span data-stu-id="1e223-107">The simplest way to implement the [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface is a pass-through implementation that authorizes all users.</span></span> <span data-ttu-id="1e223-108">Este exemplo fornece sem segurança e s fornecido apenas como um llustration de como implementar a interface.</span><span class="sxs-lookup"><span data-stu-id="1e223-108">This example provides no security, and s provided only as an llustration of how to implement the interface.</span></span> <span data-ttu-id="1e223-109">Uma implementação de [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface deve substituir dois métodos: [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) e [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId).</span><span class="sxs-lookup"><span data-stu-id="1e223-109">An implementation of the  [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface must override two methods: [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) and [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId).</span></span> <span data-ttu-id="1e223-110">Neste exemplo, o [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) sempre retorna o **WindowsIdentity** objeto associado com o usuário atual .</span><span class="sxs-lookup"><span data-stu-id="1e223-110">In this example, the [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) always returns the **System.Security.Principal.WindowsIdentity** object associated with the current user.</span></span>
...
### <a name="role-based-authorization"></a><span data-ttu-id="1e223-111">Autorização baseada em função</span><span class="sxs-lookup"><span data-stu-id="1e223-111">Role-based authorization</span></span>

<span data-ttu-id="1e223-112">O exemplo a seguir implementa uma política de autorização baseada em função.</span><span class="sxs-lookup"><span data-stu-id="1e223-112">The following example implements a role-based authorization policy.</span></span> <span data-ttu-id="1e223-113">A política é definida em um arquivo XML que reside no diretório principal do aplicativo com o Web. config e arquivos de esquema de mapeamento do MOF e XML.</span><span class="sxs-lookup"><span data-stu-id="1e223-113">The policy is defined in an XML file that resides in the main application directory with the web.config and MOF and XML mapping schema files.</span></span> <span data-ttu-id="1e223-114">Para obter informações sobre como configurar o arquivo de esquema de autorização, consulte [autorização baseada em função configurando](./configuring-role-based-authorization.md).</span><span class="sxs-lookup"><span data-stu-id="1e223-114">For information about how to configure the authorization schema file, see [Configuring Role-based Authorization](./configuring-role-based-authorization.md).</span></span> <span data-ttu-id="1e223-115">A primeira parte do exemplo implementa o [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) e [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId) métodos.</span><span class="sxs-lookup"><span data-stu-id="1e223-115">The first part of the sample implements the [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) and [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId) methods.</span></span> <span data-ttu-id="1e223-116">Nesse caso, os métodos de interface chamam métodos no `RbacSystem` classe (definida abaixo) que fazem o trabalho real de verificar as permissões para o usuário.</span><span class="sxs-lookup"><span data-stu-id="1e223-116">In this case, the interface methods call methods in the `RbacSystem` class (defined below) that do the actual work of checking the permissions for the user.</span></span>
...
<span data-ttu-id="1e223-117">O exemplo a seguir cria uma classe que analisa a política de autorização no arquivo XML.</span><span class="sxs-lookup"><span data-stu-id="1e223-117">The following example creates a class that parses authorization policy in the XML file.</span></span>
...
```
 ...
 <span data-ttu-id="1e223-118">As classes a seguir representam os grupos e usuários, respectivamente.</span><span class="sxs-lookup"><span data-stu-id="1e223-118">The following classes represent groups and users, respectively.</span></span>
...
<span data-ttu-id="1e223-119">Por fim, a classe RbacSystem implementa métodos que fazem o trabalho de verificar as permissões para o usuário e retornam o status de autorização para os métodos definidos na implementação do [Microsoft.Management.Odata.Customauthorization ](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface.</span><span class="sxs-lookup"><span data-stu-id="1e223-119">Finally, the RbacSystem class implements methods that do the work of checking the permissions for the user and return the authorization status to the methods defined in the implementation of the [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface.</span></span>