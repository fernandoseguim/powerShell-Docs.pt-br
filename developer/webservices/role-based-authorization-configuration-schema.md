---
title: Esquema de configuração de autorização baseada em função | Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
---
# <a name="role-based-authorization-configuration-schema"></a>Esquema de configuração de autorização baseada em função

O [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) amostra usa arquivos XML para configurar a política de autorização. O XSD a seguir define o esquema usado para esses arquivos.
