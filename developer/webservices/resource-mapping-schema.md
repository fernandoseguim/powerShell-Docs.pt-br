---
title: Esquema de mapeamento de recursos | Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56862692"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="2a53c-102">Esquema de mapeamento de recursos</span><span class="sxs-lookup"><span data-stu-id="2a53c-102">Resource Mapping Schema</span></span>

<span data-ttu-id="2a53c-103">Extensão IIS do Management OData usa arquivos XML para definir o mapeamento do recurso.</span><span class="sxs-lookup"><span data-stu-id="2a53c-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="2a53c-104">O XSD a seguir define o esquema usado para esses arquivos.</span><span class="sxs-lookup"><span data-stu-id="2a53c-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="2a53c-105">Arquivo XSD de mapeamento de recursos</span><span class="sxs-lookup"><span data-stu-id="2a53c-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="2a53c-106">O XSD a seguir define o esquema para arquivos de mapeamento do recurso de extensão IIS do Management OData.</span><span class="sxs-lookup"><span data-stu-id="2a53c-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
