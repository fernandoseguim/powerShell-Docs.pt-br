...
---
# <a name="resource-mapping-schema"></a>Esquema de mapeamento de recursos

Extensão IIS do Management OData usa arquivos XML para definir o mapeamento do recurso. O XSD a seguir define o esquema usado para esses arquivos.

## <a name="resource-mapping-file-xsd"></a>Arquivo XSD de mapeamento de recursos

O XSD a seguir define o esquema para arquivos de mapeamento do recurso de extensão IIS do Management OData.
