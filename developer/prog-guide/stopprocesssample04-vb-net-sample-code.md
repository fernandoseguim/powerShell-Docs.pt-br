...
---
# <a name="stopprocesssample04-vbnet-sample-code"></a>Código de exemplo StopProcessSample04 (VB.NET)

Aqui está o código de exemplo VB.NET completo para o cmdlet de exemplo StopProc04. Este é o código para o `Stop-Process` cmdlet descrito [adicionando conjuntos de parâmetros para um Cmdlet](../cmdlet/adding-parameter-sets-to-a-cmdlet.md). O `Stop-Process` cmdlet é projetado para interromper os processos que são recuperados usando o cmdlet Get-Proc (descrito na [criando seu primeiro Cmdlet](../cmdlet/creating-a-cmdlet-without-parameters.md)).
