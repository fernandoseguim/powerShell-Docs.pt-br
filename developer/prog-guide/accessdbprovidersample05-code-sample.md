...
O código a seguir mostra a implementação do provedor de navegação do Windows PowerShell descrito em [criando um provedor de navegação do Windows PowerShell](./creating-a-windows-powershell-navigation-provider.md). Esse provedor oferece suporte a comandos recursivos, contêineres aninhados e caminhos relativos que lhe permitem navegar o armazenamento de dados.
