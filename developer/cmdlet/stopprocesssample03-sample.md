...
Este exemplo mostra como gravar um cmdlet, cujos parâmetros têm aliases e cujos parâmetros de suportam a caracteres curinga. Esse cmdlet é semelhante ao `Stop-Process` cmdlet fornecido pelo Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Como criar o exemplo usando o Visual Studio.

1. Com o Windows PowerShell 2.0 do SDK instalado, navegue até a pasta StopProcessSample03. O local padrão é C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample03.
...
- Adicionar aliases a declarações de parâmetro...

- Adicionando suporte a caracteres curinga para parâmetros.

## <a name="example"></a>Exemplo

Este exemplo mostra como declarar aliases de parâmetro e dar suporte a curingas.
