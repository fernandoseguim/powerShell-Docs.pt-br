...
Especifica o número de caracteres de dados são deslocados da margem direita. Esse elemento é usado durante a definição de controles que podem ser usados por um modo de exibição.
...
Especifique o número de caracteres que você deseja deslocar os dados para a direita.
