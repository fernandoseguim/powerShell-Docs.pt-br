...
> [!NOTE]
> Este tópico discute os certificados usados para criptografia.
...
4. importa o certificado de chave privada no repositório de certificados My(Personal) no **Nó de destino**.
...
O bloco de dados de configuração define em quais nós de destino vai operar, se vai criptografar as credenciais ou não, o meio de criptografia e outras informações. Para obter mais informações sobre o bloco de dados de configuração, consulte [Separando Dados de Configuração e de Ambiente](../configurations/configData.md).
