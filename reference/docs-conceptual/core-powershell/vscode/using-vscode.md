...
2. Dois painéis de editor serão exibidos.
...
3. Substitua a configuração pelo caminho para o executável desejado do PowerShell
4. Salve o arquivo de configurações e reinicie o Visual Studio Code
