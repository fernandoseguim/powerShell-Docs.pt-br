...
Você pode criar objetos WSH especificando essas progids: **WScript. Shell**, **Wscript. Network**, **Dictionary**, e **Scripting. FileSystemObject**. Os comandos a seguir criam esses objetos:
