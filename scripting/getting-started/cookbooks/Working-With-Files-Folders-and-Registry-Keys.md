...
-   <span data-ttu-id="aeeff-132">O ponto de interrogação (?) corresponde exatamente a um caractere.</span><span class="sxs-lookup"><span data-stu-id="aeeff-132">Question mark (?) matches exactly one character.</span></span>
