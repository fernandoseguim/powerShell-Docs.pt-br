...
|Fluxo de Trabalho do [!INCLUDE[wps_2](../Token/wps_2_md.md)]|Um fluxo de trabalho é uma sequência de etapas programadas e conectadas que executam tarefas de execução longa ou exigem a coordenação de várias etapas em vários dispositivos ou nós gerenciados. O Fluxo de Trabalho do [!INCLUDE[wps_2](../Token/wps_2_md.md)] permite que os profissionais e desenvolvedores de TI criem sequências de atividades de gerenciamento de vários dispositivos, ou tarefas únicas dentro de um fluxo de trabalho, como fluxos de trabalho. O Fluxo de Trabalho do [!INCLUDE[wps_2](../Token/wps_2_md.md)] permite adaptar e executar ambos scripts e arquivos XAML do [!INCLUDE[wps_2](../Token/wps_2_md.md)] como fluxos de trabalho.|
