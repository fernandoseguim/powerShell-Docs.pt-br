...
-   **Seleção de blocos**. Você pode selecionar um bloco de texto segurando a tecla ALT enquanto seleciona o texto no painel de script com o mouse ou pressionando **Alt+Shift+Seta**.
...
> [!NOTE]
> Como o [!INCLUDE[ise_2](../Token/ise_2_md.md)] requer uma interface do usuário gráfica, você não pode executá-lo em uma opção Server Core do Windows Server.
