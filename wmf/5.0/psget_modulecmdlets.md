...
Para cada módulo, há também campos de metadados associados a ele. Para exibir os metadados corretamente na Galeria do PowerShell, você pode usar o Update-ModuleManifest para popular esses campos em PrivateData.
```powershell
