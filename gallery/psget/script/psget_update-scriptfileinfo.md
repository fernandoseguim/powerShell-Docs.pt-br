...
- Ele também permite que você adicione informações do arquivo de script a arquivos de script existentes que não foram criados usando o cmdlet New-ScriptFileInfo.
